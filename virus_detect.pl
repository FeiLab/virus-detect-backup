...
#  --reference		Name of the reference virus database file in
#                        fasta format  [vrl_plant]
#  --host_reference	Name of the host reference file in fasta format
#                        for subtraction [Null]
#  --thread_num		Number of threads (multi-threading mode) [8] 
# 
# BWA options (align sRNA to reference virus or host sequences):
...
# 
# blast alignment options (remove redundancy within virus contigs):
...
#
# blast alignment  options (align virus contigs to reference virus 
...
#  --depth_cutoff	Average depth cutoff of reported contigs that 
#                        are aligned to a virus reference [5]
########################################################################
_EOUSAGE_
;
...
# Plan, combine below script to this file,
# 1. bwa_align and correct
# 2. remove redundancy
# 3. velvet related script
